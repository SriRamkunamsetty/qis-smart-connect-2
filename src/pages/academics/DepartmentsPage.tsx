                ...
                {dept.courses.map((course, i) => (
                  <div key={course} className="feature-card">
                    ...
                    >
                      ...
                      {expanded === `${activeDept}-${i}` ? <ChevronUp className="w-4 h-4 text-muted-foreground" /> : <ChevronDown className="w-4 h-4 text-muted-foreground" />}
                    </div>
                    {expanded === `${activeDept}-${i}` && (
                      <div className="mt-4 pt-4 border-t border-border animate-fade-in">
                        <p className="text-sm text-muted-foreground mb-3">4-year program with strong industry exposure, research opportunities, and 100% placement assistance.</p>
